...
namespace TestLib {
// SECC Tester
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_001(in HAL_61851_Listener v_HAL_61851_Listener,
...
hexstring v_result = v_responseMessage.mme_payload.
...
log("The repetition limit is not reached, a new CM_VALIDATE.REQ message will be send.");
}
}
...
par_TP_EV_vald_toggleMATCH_SKIP 10.0) - 1.0),2);
SECC_Tester::pt_SLAC_Port->send(md_CMN_CMN_SlacMme_001(
md_CMN_CMN_SlacMmeCmnHeader_001({
CM_VALIDATE_REQ = "6078"}),
...
result;
ToggleNum_TYPE v_toggle_num = v_responseMessage.mme_payload.
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_002() runs on SECC_Tester return VerdictValue {
boolean v_repetition = true;
integer v_count1 = 0;
MME v_responseMessage;
if(f_checkValidToggleConfig()) {
...
-> value v_responseMessage {
SECC_Tester::tc_TT_match_response->stop();
hexstring v_result = v_responseMessage.mme_payload.payload.
...
if(getverdict() == pass){
hexstring v_pilotTimer = int2hex(float2int(par_TP_EV_vald_toggleMATCH_SKIP 10.0),2);
SECC_Tester::tc_TT_match_response->start(par_TT_match_response);
SECC_Tester::pt_SLAC_Port->send(md_CMN_CMN_SlacMme_001(
md_CMN_CMN_SlacMmeCmnHeader_001({
CM_VALIDATE_REQ = "6078"}),
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_003(in HAL_61851_Listener v_HAL_61851_Listener)
runs on SECC_Tester return VerdictValue {
MME v_responseMessage;
...
[] SECC_Tester::pt_SLAC_Port->receive(md_CMN_CMN_SlacMme_001(md_CMN_CMN_SlacMmeCmnHeader_001({
CM_ATTEN_CHAR_IND = "606E"}),MATCH_ANY)) {
SECC_Tester::tc_TT_match_response->stop();
SECC_Tester::tc_TT_match_response->start(par_TT_match_response);
SECC_Tester::pt_SLAC_Port->send(md_CMN_CMN_SlacMme_001(
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_004(in HAL_61851_Listener v_HAL_61851_Listener,
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_005(in template(present) MME_Payload mmePayload)
runs on SECC_Tester return VerdictValue {
MME v_responseMessage;
MACAddress_TYPE v_address;
SECC_Tester::tc_TT_match_response->start(par_TT_match_response);
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_006() runs on SECC_Tester return VerdictValue {
boolean v_repetition = true;
integer v_count1 = 0;
MME v_responseMessage;
if(f_checkValidToggleConfig()) {
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_007(in HAL_61851_Listener v_HAL_61851_Listener)
runs on SECC_Tester return VerdictValue {
MME v_responseMessage;
// encoding vald toggle time
hexstring v_pilotTimer = int2hex(float2int((
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_008(in Result_TYPE p_result)
runs on SECC_Tester
return VerdictValue {
boolean v_repetition = true;
integer v_count1 = 0;
...
// SLAC Tester
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_009() runs on SLAC_Tester return VerdictValue {
boolean v_repetition = true;
integer v_count1 = 0;
MME v_responseMessage;
while(v_repetition){
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_010(in HAL_61851_Listener v_HAL_61851_Listener)
runs on SECC_Tester return VerdictValue {
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidatePreCondition_001() runs on SLAC_Tester
return VerdictValue {
MME v_responseMessage;
boolean v_repetition = true;
...
log("TT_matching_repetition is still running. A new Matching process is started.");
v_count1 = 0;
}
else {
...
if((int2float(C_vald_nb_toggles)MATCH_SKIP par_TP_EV_vald_state_durationMATCH_SKIP 3.0) <
