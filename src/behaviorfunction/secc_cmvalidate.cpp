...
namespace TestLib {
// SECC Tester
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_001(HAL_61851_Listener v_HAL_61851_Listener,
...
if (SECC_Tester::pt_SLAC_Port->receive(md_CMN_CMN_SlacMme_001(md_CMN_CMN_SlacMmeCmnHeader_001({
CM_ATTEN_CHAR_IND = "606E"}),MATCH_ANY))) {
SECC_Tester::tc_TT_match_response->stop();
SECC_Tester::tc_TT_match_response->start(par_TT_match_response);
SECC_Tester::pt_SLAC_Port->send(md_CMN_CMN_SlacMme_001(
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_004(HAL_61851_Listener v_HAL_61851_Listener,
...
VerdictValue f_SECC_CMN_TB_VTB_CmValidate_005(template(present) MME_Payload mmePayload) {
