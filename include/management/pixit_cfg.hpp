  ...
  namespace Pixit_15118
  {
    ...
    namespace PIXIT_15118
    {
      ...
      namespace PIXIT_EVCC_Tester
      {
        ...
        extern Pause PIXIT_EVCC_CMN_Pause;
      }
    }
  }
  namespace Pixit_15118_3
  {
    ...
    namespace PIXIT_15118_3
    {
      ...
      namespace PIXIT_SECC_Tester
      {
        ...
        extern CLHandling PIXIT_SECC_AC_ConnectionLossHandling;
      }
      namespace PIXIT_EVCC_Tester
      {
        ...
        extern CmValidateEVCC PIXIT_EVCC_CMN_CmValidate;
        ...
        extern ValidationFallbackHandling PIXIT_EVCC_CMN_FallbackValidationFailed;
        ...
        extern ValidationFallbackHandling PIXIT_EVCC_CMN_FallbackValidationNotRequired;
        ...
        extern ConcurrentValidationHandling PIXIT_EVCC_CMN_ConcurrentValidation;
        ...
        extern boolean PIXIT_EVCC_CMN_TTMatchingRepetitionConfig;
        /* Predefined SUT value for the parameter TT_matching_repetition */
        extern float PIXIT_EVCC_CMN_TTMatchingRepetition;
        /* Predefined SUT value for the parameter TT_matching_rate */
        extern float PIXIT_EVCC_CMN_TTMatchingRate;
        ...
        extern float PIXIT_EVCC_CMN_ValidationRetry;
        /* Indication for the implemented handling after connection loss (
        ...
        extern CLHandling PIXIT_EVCC_AC_ConnectionLossHandling;
        /* Predefined SUT value for the parameter T_conn_resetup */
        extern float PIXIT_EVCC_AC_TconnResetup;
      }
    }
  }
}
